...
namespace GestionMembrePretDeLivre.Controllers
{
    public class LivreController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LivreID,Titre,Stock,Auteur,Categorie")] Livre livre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LivreID,Titre,Stock,Auteur,Categorie")] Livre livre)
        {
            if (ModelState.IsValid)
            {
